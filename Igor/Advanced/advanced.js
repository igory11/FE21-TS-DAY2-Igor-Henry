...
let objects = [];
class Vehicles {
    constructor(type, brand, model, year, mileage, fuelType, image) {
        this.type = type;
        this.brand = brand;
        this.model = model;
        this.year = year;
...
class Motorbikes extends Vehicles {
    constructor(type, brand, model, year, mileage, fuelType, image, seats) {
...
class Trucks extends Vehicles {
    constructor(type, brand, model, year, mileage, fuelType, image, weight) {
        super(type, brand, model, year, mileage, fuelType, image);
        this.type = type;
        this.brand = brand;
        this.model = model;
...
for (let x of objects) {
    document.getElementById('result').innerHTML += x.printData();
}
